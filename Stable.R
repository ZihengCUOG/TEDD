...
save(merge, file = "/mnt/hwstor9k_data1/lgg/young/zhouziheng/single-cell/database/function/Temporalfinal/mouse/Stable/tissue.Rda")
...
save(merge2, file = "/mnt/hwstor9k_data1/lgg/young/zhouziheng/single-cell/database/function/Temporalfinal/mouse/Stable/timepoint.Rda")
...
write.csv(t, file = "m.stable.csv",row.names = F)
