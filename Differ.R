...
library(pheatmap)
mat <- read.csv("/Users/ddlove/Desktop/stLFR/数据库/datav8.2/Temporalv6.23/differ/h.multigene.csv",row.names = 1, check.names = F)
gene <- read.csv("/Users/ddlove/Desktop/stLFR/数据库/datav8.2/Temporalv6.23/differ/h.differ.gene.csv")
